      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            <Image src="/airotron-logo.png" alt="Airotron Logo" width={150} height={50} className="mb-4" />
            <p className="text-blue-200">Keeping you cool since 1979</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              {footerLinks.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="text-blue-200 hover:text-white transition duration-150 ease-in-out">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="text-blue-200">123 Cool Street</p>
            <p className="text-blue-200">Frosty City, FC 12345</p>
            <p className="text-blue-200">Phone: (555) 123-4567</p>
            <p className="text-blue-200">Email: info@airotron.com</p>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-red-600 text-center text-red-200">
